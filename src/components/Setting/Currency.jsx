      ...
      <table id='my-table' className='border  w-full mt-3'>
        ...
        <tbody>
            <tr className='h-10'>
                ...
                <td>USD</td>
                <td>$</td>
                <td><p className='bg-green-800 w-12 flex justify-center items-center tracking-widest     text-white rounded-lg text-xs  h-4'>Active</p></td>
                <td>yes</td>
...
<div className='flex mt-10 gap-5'>
    ...
    <input className='border w-96 h-10 mt-1 text-start px-2 rounded-md' type="text"  placeholder='Enter Name'/>
    </div>

    <div>
    <label htmlFor="">Code</label><br />
    <input className='border w-96 h-10 mt-1 text-start px-2 rounded-md' type="text"  placeholder='Enter Code'/>
    </div>
...
<div className='flex mt-2 gap-5'>
    <div>
    <label htmlFor="">Symbol</label><br />
    <input className='border w-96 h-10 mt-1 text-start px-2 rounded-md' type="text"  placeholder='Enter Name'/>
    </div>

    <div>
    <label htmlFor="">Position</label><br />
    <select className='border w-96 h-10 mt-1 text-start px-2 rounded-md' type="text"  placeholder='Enter Code'>
...
<div className='mt-2'>
    ...
    <select className='border w-96 h-10 mt-1 text-start px-2 rounded-md' type="text"  placeholder='Enter Name'>
...
<div className='w-full h-12  mt-16 mb-10 '>
    ...
    <div className='w-96 h-12 bg-slate-50 m-auto flex gap-3'>
        ...
        <div className='w-52 h-12 flex justify-center items-center rounded-lg text-white bg-purple-800'>
            <p>Save</p>
        </div>
